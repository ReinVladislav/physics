...
const scrollButton6 = document.getElementById('scrollButton6').addEventListener('click', goToRecord);
const scrollButton7 = document.getElementById('scrollButton7').addEventListener('click', goToRecord);
var tarif;
...
function choosTatif(but) {
	switch (but.id) {
		...
		case 'scrollButton5':
			...
			break;
		case 'scrollButton6':
			tarif = 'Индивидуальные занятия по русскому языку';
			break;
		case 'scrollButton7':
			tarif = 'Групповые занятия по русскому языку';
			break;
		default:
			tarif = '';
			break;
